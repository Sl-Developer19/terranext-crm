...
export const COMMUNICATION_TEMPLATES: readonly CommunicationTemplate[] = [
  {
    ...
    body: 'Thank you for your interest in TerraNext. A counsellor will contact you within one working day to discuss the programmes that suit you best.',
  },
  {
    ...
    body: 'We would like to invite you to a counselling session to walk through programme options, fees and timelines. Please reply with a time that suits you.',
  },
  {
  ...
  },
  {
    ...
    refType: 'participant',
    subject: null,
    body: 'TerraNext: a fee instalment on your account is due. Please contact the finance desk if you have already paid.',
  },
  {
    ...
    body: 'Your attendance is currently below the level required for certification. Please speak to your coordinator so we can help you catch up.',
  },
  {
